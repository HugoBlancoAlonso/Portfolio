...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        indexar_diccionario("data/processed/clausulas.json", collection)
...
async def analizar_contrato(file: UploadFile = File(...)):
    ...
    try:
        ...
        ruta_pdf = "data/raw/contrato.pdf"
        ...
        ruta_limpio = "data/processed/contrato_limpio.txt"
        with open(ruta_limpio, "w", encoding="utf-8") as f:
            f.write(texto_limpio)
        
        
        print("Segmentando cláusulas...")
        clausulas = segmentar_clausulas(texto_limpio)
        
        
        print("Analizando con ChromaDB...")
        ...
        ruta_csv = "data/processed/prediccionAbusividad.csv"
